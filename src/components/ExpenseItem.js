...
const ExpenseItem = (props) => {
    ...
    return (
        ...
        <td><button style={{borderRadius : '50%',color : '#fff',backgroundColor : '#1abc9c',fontWeight : 'bold',fontSize : '1.5rem',padding : '0px'}} onClick={event=> increaseAllocation(props.name)}>+</button></td>
